/// - Remark: Generated from `#/components/schemas/BookInfoRemoteSearchQuery`.
public struct BookInfoRemoteSearchQuery: Codable, Hashable, Sendable {
    /// - Remark: Generated from `#/components/schemas/BookInfoRemoteSearchQuery/SearchInfo`.
    public struct SearchInfoPayload: Codable, Hashable, Sendable {
        /// - Remark: Generated from `#/components/schemas/BookInfoRemoteSearchQuery/SearchInfo/value1`.
        public var value1: BookInfo
        /// Creates a new `SearchInfoPayload`.
        ///
        /// - Parameters:
        ///   - value1:
        public init(value1: BookInfo) {
            self.value1 = value1
        }
    ...
    /// - Remark: Generated from `#/components/schemas/BookInfoRemoteSearchQuery/SearchInfo`.
    public var SearchInfo: BookInfoRemoteSearchQuery.SearchInfoPayload?
    /// - Remark: Generated from `#/components/schemas/BookInfoRemoteSearchQuery/ItemId`.
    public var ItemId: String?
    /// Gets or sets the provider name to search within if set.
    ///
    /// - Remark: Generated from `#/components/schemas/BookInfoRemoteSearchQuery/SearchProviderName`.
    public var SearchProviderName: String?
    /// Gets or sets a value indicating whether disabled providers should be included.
    ///
    /// - Remark: Generated from `#/components/schemas/BookInfoRemoteSearchQuery/IncludeDisabledProviders`.
    public var IncludeDisabledProviders: Bool?
    /// Creates a new `BookInfoRemoteSearchQuery`.
    ///
    /// - Parameters:
    ///   - SearchInfo:
    ///   - ItemId:
    ...
    public init(
        SearchInfo: BookInfoRemoteSearchQuery.SearchInfoPayload? = nil,
        ItemId: String? = nil,
    ...
    public init(from decoder: any Decoder) throws {
        ...
        SearchInfo = try container.decodeIfPresent(
            BookInfoRemoteSearchQuery.SearchInfoPayload.self,
            forKey: .SearchInfo
        )
