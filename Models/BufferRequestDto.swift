...
///
/// - Remark: Generated from `#/components/schemas/BufferRequestDto`.
public struct BufferRequestDto: Codable, Hashable, Sendable {
    /// Gets or sets when the request has been made by the client.
    ///
    /// - Remark: Generated from `#/components/schemas/BufferRequestDto/When`.
    public var When: Foundation.Date?
    /// Gets or sets the position ticks.
    ///
    /// - Remark: Generated from `#/components/schemas/BufferRequestDto/PositionTicks`.
    public var PositionTicks: Int64?
    /// Gets or sets a value indicating whether the client playback is unpaused.
    ///
    /// - Remark: Generated from `#/components/schemas/BufferRequestDto/IsPlaying`.
    public var IsPlaying: Bool?
    /// Gets or sets the playlist item identifier of the playing item.
    ///
    /// - Remark: Generated from `#/components/schemas/BufferRequestDto/PlaylistItemId`.
    public var PlaylistItemId: String?
    /// Creates a new `BufferRequestDto`.
    ///
    /// - Parameters:
